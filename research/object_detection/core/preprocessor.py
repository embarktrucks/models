...
def random_adjust_brightness(image, max_delta=0.2):
    ...
    with tf.name_scope('RandomAdjustBrightness', values=[image]):
        ...
        image = tf.clip_by_value(image, clip_value_min=min_value, clip_value_max=max_value)
...
def ssd_random_crop_fixed_aspect_ratio(
    ...
    crop_result = ssd_random_crop(
        ...
        aspect_ratio_range, area_range, overlap_thresh, random_coef, clip_bboxes, seed)
    i = 3
